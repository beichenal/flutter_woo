...
class SearchFilterController extends GetxController {
  ...
  void _loadCache() async {
    ...
    {
      String result =
          await Storage().getString(Constants.storageProductsAttributesSizes);
    ...
    {
      String result =
          await Storage().getString(Constants.storageProductsAttributesColors);
    ...
    {
      String result =
          await Storage().getString(Constants.storageProductsAttributesBrand);
    ...
    {
      String result =
          await Storage().getString(Constants.storageProductsAttributesGender);
    ...
    // 新旧列表
    {
      String result = await Storage()
          .getString(Constants.storageProductsAttributesCondition);
      conditions =
